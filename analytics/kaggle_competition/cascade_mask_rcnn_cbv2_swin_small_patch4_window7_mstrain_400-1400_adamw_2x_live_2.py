...
train_pipeline = [
    ...
    dict(
        type='Resize',
        img_scale=[(440, 600), (480, 650), (520, 704)],
...
data = dict(samples_per_gpu=samples_per_gpu,
            ...
            train=dict(
                ...
                classes=('cell',),
                ann_file='../data/livecell_images/livecell_coco_train_new.json',
            ...
            val=dict(
                ...
                pipeline=test_pipeline,
                classes=('cell',),
                ann_file='../data/livecell_images/livecell_coco_val_new.json',
                img_prefix='../data/livecell_images/livecell_images/'))
...
seed=0
gpu_ids = range(1)
work_dir = './live_version_swin_small'
