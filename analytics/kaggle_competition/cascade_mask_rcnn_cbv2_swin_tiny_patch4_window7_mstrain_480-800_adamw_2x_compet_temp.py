...
data = dict(samples_per_gpu=samples_per_gpu,
            ...
            train=dict(
                ...
                classes=('cell',),
                ann_file='../data/livecell_images/competition_coco_train.json',
                img_prefix='../data/livecell_images/train/'
                       ),
            test=dict(
                type='CocoDataset',
                pipeline=test_pipeline,
                classes=('cell',),
                ann_file='../data/livecell_images/competition_coco_test.json',
                img_prefix='../data/livecell_images/train/'
                ),
            val=dict(
                type='CocoDataset',
                pipeline=test_pipeline,
                classes=('cell',),
                ann_file='../data/livecell_images/competition_coco_val.json',
                img_prefix='../data/livecell_images/train/'))
