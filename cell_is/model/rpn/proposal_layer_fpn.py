...
class _ProposalLayer_FPN(nn.Module):
    ...
    def __init__(self, feat_stride, scales, ratios):
        ...
        self._fpn_scales = np.array(cfg.FPN_ANCHOR_SCALES) # [32, 64, 128, 256, 512]
        self._fpn_feature_strides = np.array(cfg.FPN_FEAT_STRIDES) # [4, 8, 16, 32, 64]
        self._fpn_anchor_stride = cfg.FPN_ANCHOR_STRIDE # 1
